...
function lovepatch.load(filename, arg1, arg2, arg3, arg4)
	local image = love.graphics.newImage(filename)

	if arg3 == nil and arg4 == nil then
		return lovepatch.loadSameEdge(image, arg1, arg2)
	end

	return lovepatch.loadDiffrntEdge(image, arg1, arg2, arg3, arg4)
end

function lovepatch.loadDiffrntEdge(image, left, right, top, bottom)
...
function lovepatch.loadSameEdge(image, edgeW, edgeH)
	local imageW, imageH = image:getDimensions()
...
function lovepatch.draw(patch, x, y, width, height)
